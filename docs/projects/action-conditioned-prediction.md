...
给定当前状态和动作，预测下一步；并证明模型对动作变化敏感。

## 学习目标

完成本项目后，读者应该能够：

- [ ] 无动作 / 错误动作 / 正确动作三种条件可被区分
- [ ] 记录一步误差和多步 rollout 误差
- [ ] 说明评价发生在像素空间还是 latent 空间
...
- 对应代码：`examples/06-latent-dynamics/`
...
<div class="viz-slot" data-viz="placeholder" data-viz-config='{"title":"动作条件预测","note":"项目结果图与失败案例待补充。"}'>
